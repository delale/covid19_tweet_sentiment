...
Hence a factor coding of the sentiment scores and a multinomial regression was also applied to answer this question.  
...
plt1 <- ggplot(
    ...
    xlab("log(confirmed cases)") +
    ylab("Daily Sentiment mean") +
    theme_bw() +
